...
class staticedf_final
{
    ...
    public static void main(String[] args)
    {
        ...
        double f=availablefreq[index]/4.0;;
        ...
        System.out.println("Energy is "+(busytime*availablevolt[index]*availablevolt[index]*0.75+idletime*4*4));
